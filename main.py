    ...
    try:
        ...
        def superuser_menu(self):
            ...
            while(i not in range(1,9)):
                if i == 9:
                    ...
                    i = int(input("Please enter your choice, and make sure it's between 1 to 9\n"))
            else:     
                if i == 1:
                    self.create_member()
                    self.superuser_menu()
        ...
        def create_member(self):
            ...
            while num in member_details_dict:
                ...
                password = input("Let's create new password!! Enter the password\n")
                member_details_dict[num]["Password"] = password
        ...
        def update_member(self):
            ...
            if check in member_details_dict:
                ...
                for i in member_details_dict[check]:
                    ...
                    label += 1
                val = input("Please enter the NAME of the detail you wish to update (e.g. Full Name)\n")
        ...
        def create_regimen(self):
            ...
            while(regimen_name in regimens_dict):
                ...
                regimen_name = input('Please give a name to the new regimen! (something that you will remember)\n')
            else:
    ...
    def __init__(self):
        try:
            ...
            if self.num in member_details_dict:
                print("Welcome, {} to GETFIT gym!".format(member_details_dict[self.num]['Full Name']))
                self.member_menu()
            elif self.password in member_details_dict[self.num]['Full Name']:
                print("Welcome, {} to GETFIT gym!".format(member_details_dict[self.num]['Full Name']))
                self.member_menu()
            else:
                print("Sorry it seems, you are not a member!\n Please add your details using create member!") 
                
                
        except:
            print("Please enter correct details, it seems, you are not a member! or You have entered wrong password!")
        ...
        try:
            ...
            while(i not in range(1,4)):
                if i == 4:
                    login()
                    break
                i = int(input("Please enter a valid value!(Either 1 or 2 or 3)"))
            else:
                if i == 1:
                    self.member_regimen()
                    self.member_menu()
    ...
    def member_update(self):
        ...
        if check in member_details_dict:
            ...
            for i in member_details_dict[check]:
                print('{}. {}'.format(label, i))
                label += 1
            val = input("Please enter the NAME of the detail you wish to update (e.g. Full Name) Make sure you enter name of the detail as shown in above list, NO NUMERIC VALUES! \n")
